        ...
        <div class="box">
            ...
            <div class="main">
                ...
                <form method="post" class="basicInput" id="dissolve-two" action="signup_connection.php">
                    ...
                    <input type="textarea" name="mob" id="mob" class="text-box" placeholder="mob" required>
                    </div>
                    ...
                    <input type="textarea" name="pincode" id="pincode" class="text-box" placeholder="pincode" required>
                    </div>
